...
class MessageTest < Minitest::Test
  ...
  def build_message(body:, content_type: nil, content_encoding: nil, headers: nil)
  ...
  def test_decode_with_unsupported_encoding
    message = build_message(body: "data", content_encoding: "unsupported")
    assert_raises(AMQP::Client::Error::UnsupportedContentEncoding) { message.decode }
  end

  def test_parse_with_unsupported_content_type
    message = build_message(body: "data", content_type: "application/xml")
